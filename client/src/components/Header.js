...
const Header = () => {
  return (
    <div className="flex w-full p-4 items-center justify-center gap-10 text-[#333] text-[18px] font-medium">
      <div className="w-[30%] flex justify-start items-center gap-2 font-bold">
        <NavLink to={"/"}>
          <svg
            ...
            height="16"
            fill="currentColor"
            class=" w-10 h-10 text-primarycolor"
            viewBox="0 0 16 16"
          >
        ...
        <NavLink to={"/"}>
          <p className="text-40px uppercase text-primarycolor">EasyDone</p>
        </NavLink>
      </div>
      <div>
        <nav class="main-nav">
      ...
      <NavLink to={"/login"} className="w-[30%] flex items-end justify-end">
        <p>Sign In</p>
      </NavLink>
    </div>
  );
